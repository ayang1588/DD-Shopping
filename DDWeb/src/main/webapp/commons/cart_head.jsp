...
<div class="ddnewhead_wrap">
    <div class="ddnewhead_content ddnewhead_content2">
        <div class="ddnewhead_operate" id="__ddnav_menu">
            ...
            <p id="nickname">欢迎光临当当网，请<a name="ddnav_login" href="#" target="_self" class="login_link">登录</a><a
                    name="ddnav_register" href="/regist/toRegist" target="_self" class="login_link">免费注册</a></p>
        </div>
        <div class="ddnewhead_logo"><a href="/" title="返回首页" name="ddnav_logo"><img
                src="${pageContext.request.contextPath}/images/ddnewhead_logo.gif" alt="当当网"></a></div>
        <div class="clear"></div>
    </div>
