...
public class Book {
    ...
    public String toString() {
        return id + "," + author + "," + publishing + "," + publishTime + "," + whichEdtion + "," + totalPage + "," + wordNumber + "," + bookSize + "," +
                paperType + "," + printTime + "," + printNumber + "," + isbn + "," + packType + "," + contentSummary + "," + authorSummary + "," +
                catalogue + "," + mediaComments;
    }
}